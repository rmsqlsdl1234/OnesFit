...
<title>Insert title here</title>
	...
	$(function() {
		$("#back").on("click", function() {
			if(confirm("뒤로가기시 작성한 내용은 저장되지 않습니다. 정말 뒤로가시겠습니까?")){
			location.href = "../notice/view?n_seq="+${result.n_seq};
			}
		})
	});
	</script>
    ...
    <body>
        ...
        <div id=OSF_ALL>
            ...
            <div id="container">
                ...
                <!--               중앙 내용-->
                <form action="../notice/modifyProc" method="post">
                <div id="contents">
                <div>Notice</div>
               		...
               		<div style="width: 1000px;">
               			<textarea name="contents" id="summernote2"></textarea>
               		</div>
               		<div style="width: 1000px; margin-top: 10px; text-align: right;">
               			<input type="submit" id="sbtn" value="수정하기">&nbsp;&nbsp;<input type="button" id="back" value="뒤로가기">
               		</div>
        ...
        <div style="width: 1050px; margin-left: 430px;">
