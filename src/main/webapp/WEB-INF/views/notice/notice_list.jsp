    ...
    <body>
        ...
        <div id=OSF_ALL>
            ...
            <div id="container">
                ...
                <div class="nheader" style="width: 5%; border-right: 0.5px solid #eeeeee;">번호</div>
                ...
                <c:forEach var="i" items="${list}">
         		...
         		<div class="ncontents" style="width: 60%; border: 0.5px solid #eeeeee;"><a href="view?n_seq=${i.n_seq}" id="n_hover" style="text-decoration: none; color: #585858">${i.title}</a></div>
