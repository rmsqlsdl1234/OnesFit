...
public class NoticeService {
	...
	public String getPageNavi(int currentPage)throws Exception{
		...
		if(needPrev) {
			sb.append("<a style=\"text-decoration: none;\" href=\"/notice/notice_list?page="+(startNavi-1)+"\">< </a>");
		}
		for(int i = startNavi; i<=endNavi; i++) {
			sb.append("<a style=\"text-decoration: none;\" href=\"/notice/notice_list?page="+i+"\">"+i+"</a>  ");	
		}
		if(needNext) {
			sb.append("<a style=\"text-decoration: none;\" href=\"/notice/notice_list?page="+(endNavi+1)+"\"> ></a>");
		}
		return sb.toString();
	}
